...
cell AMX_NATIVE_CALL n_EVF9_GetFirstVehicle(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetNextVehicle(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_BeginSave(AMX* amx, cell* params)
{
    return VehicleSystem::getInstance().beginSave(params[1]) ? 1 : 0;
}

/* native EVF9_EndSave(vehicleid); */
cell AMX_NATIVE_CALL n_EVF9_EndSave(AMX* amx, cell* params)
{
    return VehicleSystem::getInstance().endSave(params[1]) ? 1 : 0;
}

/* native EVF9_IsVehicleSaving(vehicleid); */
cell AMX_NATIVE_CALL n_EVF9_IsVehicleSaving(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleSaveState(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_SetVehicleMeta(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_GetVehicleMeta(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int key = (int)params[2];
...
cell AMX_NATIVE_CALL n_ResetVehicleMeta(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int key = (int)params[2];
...
cell AMX_NATIVE_CALL n_HasVehicleMeta(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int key = (int)params[2];
...
cell AMX_NATIVE_CALL n_RegisterVehicleProperty(AMX* amx, cell* params)
{
    char name[128];
...
cell AMX_NATIVE_CALL n_SetVehiclePropertyInt(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_SetVehiclePropertyFloat(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];
...
cell AMX_NATIVE_CALL n_SetVehiclePropertyString(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];
...
cell AMX_NATIVE_CALL n_GetVehiclePropertyInt(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];
...
cell AMX_NATIVE_CALL n_GetVehiclePropertyFloat(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];
...
cell AMX_NATIVE_CALL n_GetVehiclePropertyString(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];
...
cell AMX_NATIVE_CALL n_HasVehicleProperty(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    int propid = (int)params[2];

...
cell AMX_NATIVE_CALL n_EVF9_RegisterVehicle(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_SetVehicleLastDriver(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;

...
cell AMX_NATIVE_CALL n_EVF9_GetVersion(AMX* amx, cell* params)
{
    return EVF9_VERSION;
}

/* native EVF9_GetBuild(); */
cell AMX_NATIVE_CALL n_EVF9_GetBuild(AMX* amx, cell* params)
{
    return EVF9_BUILD;
}

/* native EVF9_RegisterAddon(const name[], const version[]); */
cell AMX_NATIVE_CALL n_EVF9_RegisterAddon(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_UnregisterAddon(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetAddonInfo(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetMemoryUsage(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleMemoryUsage(AMX* amx, cell* params)
{
    return (cell)sizeof(VehicleEntity);
}

/* native EVF9_GetModuleMemoryUsage(module[]); */
cell AMX_NATIVE_CALL n_EVF9_GetModuleMemoryUsage(AMX* amx, cell* params)
{
    return (cell)sizeof(ModuleRegistry);
}

/* native EVF9_GetTotalVehicles(); */
cell AMX_NATIVE_CALL n_EVF9_GetTotalVehicles(AMX* amx, cell* params)
{
    return VehicleSystem::getInstance().count();
}

/* native EVF9_GetManagedVehicles(); */
cell AMX_NATIVE_CALL n_EVF9_GetManagedVehicles(AMX* amx, cell* params)
{
    return VehicleSystem::getInstance().count();
}

/* native EVF9_GetSpawnedVehicles(); */
cell AMX_NATIVE_CALL n_EVF9_GetSpawnedVehicles(AMX* amx, cell* params)
{
    int spawned = 0;
...
cell AMX_NATIVE_CALL n_EVF9_GetDestroyedVehicles(AMX* amx, cell* params)
{
    return 0;
}

/* native EVF9_GetAbandonedVehicles(); */
cell AMX_NATIVE_CALL n_EVF9_GetAbandonedVehicles(AMX* amx, cell* params)
{
    int count = 0;
    int vid = VehicleSystem::getInstance().getFirst();
    while (vid != -1)
...
cell AMX_NATIVE_CALL n_EVF9_StartProfiler(AMX* amx, cell* params) { return 1; }

/* native EVF9_StopProfiler(); */
cell AMX_NATIVE_CALL n_EVF9_StopProfiler(AMX* amx, cell* params)  { return 1; }

/* native EVF9_GetProfilerData(data[], len); */
cell AMX_NATIVE_CALL n_EVF9_GetProfilerData(AMX* amx, cell* params)
{

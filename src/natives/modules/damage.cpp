...
cell AMX_NATIVE_CALL n_RepairVehicleDamage(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_DestroyVehiclePart(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_RepairVehiclePart(AMX* amx, cell* params)
{
 ...
 */
cell AMX_NATIVE_CALL n_GetVehicleDamageData(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_ResetVehicleDamage(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    v->health = 1000.0f;

...
cell AMX_NATIVE_CALL n_SetVehicleFuel(AMX* amx, const cell* params)
{
...
cell AMX_NATIVE_CALL n_GetVehicleFuel(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_AddVehicleFuel(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_RemoveVehicleFuel(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    float oldFuel = v->fuel;
...
cell AMX_NATIVE_CALL n_IsVehicleOutOfFuel(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_GetFuelConsumptionRate(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_SetFuelConsumptionRate(AMX* amx, const cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;

...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleModel(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleSpawnPos(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleWorld(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleInterior(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleFlags(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleCreatedAt(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleLastDriver(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleLastOccupant(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleDistanceTravelled(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_IsVehicleSpawned(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_IsVehicleManaged(AMX* amx, cell* params)
{
 ...
 */
cell AMX_NATIVE_CALL n_EVF9_GetVehicleHealth(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
 ...
 */
cell AMX_NATIVE_CALL n_EVF9_SetVehicleHealthInternal(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_EVF9_SetVehicleTag(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    char buf[65];
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleTag(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleUID(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleByUID(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_EVF9_GetVehicleLifetime(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_ResetVehicleDistance(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
    v->tripDistance = 0.0f;
...
cell AMX_NATIVE_CALL n_GetVehicleLifetimeDistance(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_GetVehicleTripDistance(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
    if (!v) return 0;
...
cell AMX_NATIVE_CALL n_IsVehicleLocked(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_IsVehicleEngineOn(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_IsVehicleTracked(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_IsVehicleAbandoned(AMX* amx, cell* params)
{
    auto* v = VehicleSystem::getInstance().get(params[1]);
...
cell AMX_NATIVE_CALL n_CountVehiclesByModel(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_CountVehiclesByOwner(AMX* amx, cell* params)
{
...
cell AMX_NATIVE_CALL n_GetNearestManagedVehicle(AMX* amx, cell* params)
{
